...
const options = [
    ...
    { name: "art", label: "art", value: "1" },
    { name: "bricolage", label: "bricolage", value: "2"},
    { name: "cinema", label: "cinéma", value: "3" },
    { name: "education", label: "éducation", value: "4" },
    { name: "jardinage", label: "jardinage", value: "5" },
    { name: "musique", label: "musique", value: "6" },
    { name: "sport", label: "sport", value: "7" },
    { name: "technologie", label: "technologie",value: "8" },
    { name: "theatre", label: "théatre", value: "9" },
    { name: "travaux", label: "travaux", value: "10" },
    { name: "voyage", label: "voyage", value: "11" },
    { name: "divers", label: "divers", value: "12" },
